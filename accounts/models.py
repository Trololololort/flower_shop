...
from .validators import cyrillic_validator, latin_space_hyphen, gte_6
...
class CustomUser(AbstractUser):
    ...
    rules = models.BooleanField(blank=False, null=False, default=False, verbose_name="Согласен с правилами регистрации")
